...
function Navbar() {
    ...
    return (
        <div className='w-full h-16 absolute top-0 z-100 flex justify-between items-center px-4 bg-gradient-to-r from-[#131316d9] via-[#222226a6] to-[#131316d9] backdrop-blur-sm'>
            ...
            <div className='flex flex-row gap-4'>
                <Link href="/cart">
                    <TooltipProvider>
                        <Tooltip>
                            <TooltipTrigger>
                                <div className="cartBtn rounded-full p-0.5 text-[0.95rem] leading-none">
