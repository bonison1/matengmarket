    ...
    return (
      <div className="w-[100vw] h-[100vh]">
        ...
        <div className="h-full text-center text-5xl font-bold text-white pt-20 flex flex-col justify-start items-center gap-10">
          <div className="text-[4rem] text-transparent bg-gradient-to-b from-white to-gray-400 bg-clip-text z-20 mt-[6%] animate-fade-in">
            We Drive, We Discover
          </div>
  
          <div className="w-full z-20">
            <div className="flex flex-row justify-center gap-10 text-[#b5b6be] text-[1.3rem] ">
              <div>
                Delivered <span className="text-green-600">{parcels}+</span>{" "}
                parcels
              </div>
              <div className="w-[2px] h-7 rounded bg-gray-200/40" />
              <div>
